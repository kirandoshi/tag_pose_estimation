...
from tag_pose_estimation.camera_extrinsic_calibration_stereo import (
    dual_camera_extrinsic_calibration,
)
...
def main():
    ...
    parser.add_argument(
        "--camera_1_config_path",
        type=str,
        help=(
            "Path to the first camera configuration file."
    ...
    parser.add_argument(
        "--camera_2_config_path",
        type=str,
        help=(
            "Path to the second camera configuration file."
            "Three options are supported: "
            "(1) Absolute path to the JSON camera configuration file, "
            "(2) Path relative to project root directory, "
            "(3) Single filename, which is then assumed to be in the "
    ...
    dual_camera_extrinsic_calibration(
        args.camera_1_config_path,
        args.camera_2_config_path,
